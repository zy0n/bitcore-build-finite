...
function startGulp(name, opts) {
  ...
  var buildPath = './node_modules/bitcore-build-finite/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = browserifyPath + ' --require ./index.js:' + fullname + ' --external bitcore-lib-finite -o ' + fullname + '.js';
    } else {
      browserifyCommand = browserifyPath + ' --require ./index.js:bitcore-lib-finite -o bitcore-lib-finite.js';
    }
